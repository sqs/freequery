...
class Pagerank(object):
    ...
    :math:`\\alpha \\in (0,1]` : parameter; a random surfer will teleport
                                 to a random page with probability
                                 :math:`(1-\\alpha)`.
    ...
    @staticmethod
    def reduce_mass(in_iter, out, params):
        from freequery.document import Document
        from freequery.graph.pagerank import DANGLING_MASS_KEY
    ...
    @staticmethod
    def map_teleport_distribute((doc,__ignore), params):
        from freequery.document import Document
        from freequery.graph.pagerank import DANGLING_MASS_KEY
